        ...
        <html>
            <body>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/MatHang">
                        <xsl:sort select="MaLoai"/>
                        <tr>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/KhachHang">
                        <tr>
                            <td><xsl:value-of select="position()"/></td>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/NhaCungCap">
                        <tr>
                            <td> <xsl:value-of select="position()"/></td>
                            <td><xsl:value-of select="MaNCC"/></td>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/LoaiMH">
                        <tr>
                            <td> <xsl:value-of select="position()"/></td>
                            <td><xsl:value-of select="MaLoai"/></td>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/HoaDon">
                        <tr>
                            <td> <xsl:value-of select="position()"/></td>
                            <td><xsl:value-of select="MaHD"/></td>
                            <td><xsl:value-of select="MaKH"/></td>
                            <td><xsl:value-of select="NgayBan"/></td>
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="QLBC/ChiTietHoaDon">
                        <tr>
                            <td> <xsl:value-of select="position()"/></td>
                            <td><xsl:value-of select="MaHD"/></td>
                            <td><xsl:value-of select="MaMH"/></td>
